class TechnicalCommittee {
  ...
  factory TechnicalCommittee.fromJson(Map<String, dynamic> json) {
  ...
  factory TechnicalCommittee.fromCompleteJson(Map<String, dynamic> json) {
    return TechnicalCommittee(
      id: json['id'] as int,
  ...
  @override
  String toString() {
    return 'TechnicalCommittee{id: $id, designation: $designation, organization: $organization, role: $committeeRole}';
  }
}
