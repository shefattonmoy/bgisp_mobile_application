...
class ExpandableOthers extends StatefulWidget {
  final IconData icon;
  final String titleKey;
  final List<OthersSubItem> children;
  final VoidCallback? onTap;
  final bool initiallyExpanded;

  const ExpandableOthers({
    super.key,
    required this.icon,
  ...
  @override
  State<ExpandableOthers> createState() => _ExpandableOthersState();
}

class _ExpandableOthersState extends State<ExpandableOthers> {
